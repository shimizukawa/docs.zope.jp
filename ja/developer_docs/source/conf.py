...
project = u'Zope Developer Information'
...
htmlhelp_basename = 'ZopeDeveloperInformationdoc'
...
latex_documents = [
  ('index', 'ZopeDeveloperInformation.tex', ur'Zope Developer Information Documentation',
