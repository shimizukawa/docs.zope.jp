...
このバージョンの Zope 2 は Python 2.6 をサポートしています。
Python 2.4, 2.5 は今後は公式サポートを行いません。
64-bit 版の Python 2.4 では Zope 2.12 は動作しないことが分かっています。
32-bit 版の Python 2.4 については動作すると思いますが、自己責任でお願いします。
Python 2.5 については今のところ非互換部分はありませんが、推奨しません。
